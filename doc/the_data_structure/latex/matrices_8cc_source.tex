...
\DoxyCodeLine{\Hypertarget{matrices_8cc_source_l00569}00569 \textcolor{comment}{  /// \(\backslash\)short Default constructor, set the default linear solver and}}
...
\DoxyCodeLine{\Hypertarget{matrices_8cc_source_l00579}00579 \textcolor{comment}{  /// \(\backslash\)short Constructor: Pass vector of values, vector of row indices,}}
...
\DoxyCodeLine{\Hypertarget{matrices_8cc_source_l01307}01307 \textcolor{comment}{  /// \(\backslash\)short Constructor: Takes the distribution and the number of columns, as}}
...
\DoxyCodeLine{\Hypertarget{matrices_8cc_source_l01360}01360 \textcolor{comment}{  /// \(\backslash\)short Runs through the column index vector and checks if the entries}}
...
\DoxyCodeLine{\Hypertarget{matrices_8cc_source_l01437}01437 \textcolor{comment}{  /// \(\backslash\)short This helper function sorts the entries in the column index vector}}
...
\DoxyCodeLine{\Hypertarget{matrices_8cc_source_l01668}01668 \textcolor{comment}{  /// \(\backslash\)short build method: Takes the distribution and the number of columns, as}}
...
\DoxyCodeLine{\Hypertarget{matrices_8cc_source_l01692}01692 \textcolor{comment}{  /// \(\backslash\)short method to rebuild the matrix, but not the distribution}}
...
\DoxyCodeLine{\Hypertarget{matrices_8cc_source_l01708}01708 \textcolor{comment}{  /// \(\backslash\)short method to rebuild the matrix, but not the distribution}}
...
\DoxyCodeLine{\Hypertarget{matrices_8cc_source_l03670}03670 \textcolor{comment}{    /// \(\backslash\)short Builds a uniformly distributed matrix.}}
...
\DoxyCodeLine{\Hypertarget{matrices_8cc_source_l03985}03985 \textcolor{comment}{    /// \(\backslash\)short Calculates the largest Gershgorin disc whilst preserving the}}
...
\DoxyCodeLine{\Hypertarget{matrices_8cc_source_l04322}04322 \textcolor{comment}{    /// \(\backslash\)short Concatenate CRDoubleMatrix matrices.}}
...
\DoxyCodeLine{\Hypertarget{matrices_8cc_source_l05174}05174 \textcolor{comment}{    /// \(\backslash\)short Concatenate CRDoubleMatrix matrices.}}
...
\DoxyCodeLine{\Hypertarget{matrices_8cc_source_l05879}05879 \textcolor{comment}{    /// \(\backslash\)short Concatenate CRDoubleMatrix matrices.}}
