...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00037}00037 \textcolor{comment}{  /// \(\backslash\)short An Epetra\_Operator class for oomph-\/lib preconditioners.}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00045}00045 \textcolor{comment}{    /// \(\backslash\)short Constructor -\/ takes the pointer to the oomph-\/lib}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00073}00073 \textcolor{comment}{    /// \(\backslash\)short Destructor -\/ deletes the Epetra\_map and My\_global\_rows vector}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00110}00110 \textcolor{comment}{    /// \(\backslash\)short applies the oomph-\/lib preconditioner. Converts the Epetra vector}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00241}00241 \textcolor{comment}{    /// \(\backslash\)short Use the epetra data within the vectors passed to the oomph-\/lib}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00246}00246 \textcolor{comment}{    /// \(\backslash\)short A pointer to an Epetra\_Map object -\/ describes distribution of the}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00258}00258 \textcolor{comment}{  /// \(\backslash\)short An interface to the Trilinos AztecOO classes allowing it to be used}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00324}00324 \textcolor{comment}{    /// \(\backslash\)short Enable workaround for creating of epetra matrix that respects}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00331}00331 \textcolor{comment}{    /// \(\backslash\)short Disable workaround for creating of epetra matrix that respects}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00338}00338 \textcolor{comment}{    /// \(\backslash\)short Is workaround for creating of epetra matrix that respects}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00383}00383 \textcolor{comment}{    /// \(\backslash\)short Function which uses problem\_pt's get\_jacobian(...) function to}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00388}00388 \textcolor{comment}{    /// \(\backslash\)short Function to solve the linear system defined by matrix\_pt and rhs.}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00397}00397 \textcolor{comment}{    /// \(\backslash\)short Function to resolve a linear system using the existing solver}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00403}00403 \textcolor{comment}{    /// \(\backslash\)short Disable resolve function (overloads the LinearSolver}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00411}00411 \textcolor{comment}{    /// \(\backslash\)short Call if the matrix can be deleted}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00417}00417 \textcolor{comment}{    ///\(\backslash\) short Call if the matrix can not be deleted (default)}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00459}00459 \textcolor{comment}{    /// \(\backslash\)short Set the assembly of the serial jacobian}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00482}00482 \textcolor{comment}{    /// \(\backslash\)short Enumerated list to define which AztecOO solver is used}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00491}00491 \textcolor{comment}{    /// \(\backslash\)short Helper function performs the actual solve once the AztecOO}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00495}00495 \textcolor{comment}{    /// \(\backslash\)short Helper function for setting up the solver. Converts the oomph-\/lib}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00501}00501 \textcolor{comment}{    /// \(\backslash\)short Use workaround for creating of epetra matrix that respects}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00517}00517 \textcolor{comment}{    /// \(\backslash\)short Trilinos copies matrix data from oomph-\/lib's own CRDoubleMatrix}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00525}00525 \textcolor{comment}{    /// \(\backslash\)short If true, when performing a problem based solve a serial matrix}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00529}00529 \textcolor{comment}{    /// \(\backslash\)short Defines which solver is set up -\/ available types are}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00533}00533 \textcolor{comment}{    /// \(\backslash\)short Helper flag keeping track of whether we called the}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00537}00537 \textcolor{comment}{    /// \(\backslash\)short A pointer for the linear system matrix in Epetra\_CrsMatrix format}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00540}00540 \textcolor{comment}{    /// \(\backslash\)short A pointer to the Epetra\_Operator for the preconditioner. This is}}
...
\DoxyCodeLine{\Hypertarget{trilinos__solver_8h_source_l00547}00547 \textcolor{comment}{    /// \(\backslash\)short A pointer to the underlying problem (NULL if MATRIX based solve)}}
