...
\DoxyCodeLine{\Hypertarget{refineable__mesh_8cc_source_l00109}00109 \textcolor{comment}{  /// \(\backslash\)short Extract the elements at a particular refinement level in}}
...
\DoxyCodeLine{\Hypertarget{refineable__mesh_8cc_source_l01883}01883 \textcolor{comment}{  /// \(\backslash\)short Refine to same degree as the reference mesh.}}
...
\DoxyCodeLine{\Hypertarget{refineable__mesh_8cc_source_l01900}01900 \textcolor{comment}{  /// \(\backslash\)short Refine to same degree as the reference mesh minus one. Useful}}
