...
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Constructor for 1D Poisson problem in unit interval.}\textcolor{comment}{}}
...
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Update the problem specs before solve: (Re)set boundary values}\textcolor{comment}{}}
