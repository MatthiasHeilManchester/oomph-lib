...
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Oscillating ellipse}\textcolor{comment}{}}
...
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Actions before timestep: Update the domain shape, then set the }\textcolor{comment}{}}
