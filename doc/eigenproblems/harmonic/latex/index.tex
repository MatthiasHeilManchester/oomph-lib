...
The shape functions are specified in the {\ttfamily \mbox{\hyperlink{classQHarmonicElement}{QHarmonic\+Element}}} class that inherits from our standard one-\/dimensional Lagrange elements {\ttfamily QElement$<$1,\+NNODE\+\_\+1\+D$>$} as well as {\ttfamily \mbox{\hyperlink{classHarmonicEquations}{Harmonic\+Equations}}}. The number of unknowns (one) is specified and the output functions and shape functions are overloaded as required\+: the output functions are specified in the {\ttfamily \mbox{\hyperlink{classHarmonicEquations}{Harmonic\+Equations}}} class, whereas the shape functions are provided by the {\ttfamily QElement$<$1,\+NNODE\+\_\+1\+D$>$} class.
...
\DoxyCodeLine{\textcolor{comment}{/// \(\backslash\)short Constructor for 1D Harmonic problem in unit interval.}\textcolor{comment}{}}
